  ...
  return (
    ...
    >
      <div className="opacity-0 hover:opacity-100 hover:bg-custom-blue h-[300px] flex justify-center text-center items-center hover:bg-opacity-70 px-2 py-2">
        ...
        <p className="text-2xl font-semibold text-white text-center">{name}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div id="projects">
      <motion.h1
        ...
        whileInView={"show"}
        viewport={{ once: true }}
        className="text-center text-[24px] md:text-[50px] font-bold mt-8"
      >
        Projects
      </motion.h1>
      <motion.p
        ...
        whileInView={"show"}
        viewport={{ once: true }}
        className="text-center text-[16px] md:text-[20px] text-[#999999]"
      >
      ...
      <motion.div
        ...
        whileInView={"show"}
        viewport={{ once: true }}
        className="grid grid-cols-1  mt-8 items-center px-11 md:grid-cols-3 gap-4 "
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 text-center mt-16 gap-3 px-4  ">
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: true }}
          className="hover:shadow-lg px-2 py-2 shadow-2xl "
        >
          {" "}
      ...
      >
        ...
        <div className="bg-custom-blue bg-opacity-70 text-center text-white items-center py-20 h-full flex flex-col px-44 gap-5">
          ...
          <motion.p
            ...
            whileInView={"show"}
            viewport={{ once: false }}
            className="font-bold md:text-[40px] text-[24px]"
          >
            I'm <span className="text-[#a0f669]">Available</span> for
            Freelancing
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2)}
          ...
          >
            {" "}
            <button className="text-base p-5 bg-custom-blue uppercase font-semibold rounded-full w-[180px] hover:text-black ">
              <a href="#send">Hire Me</a>
            </button>
          </motion.div>
        </div>
      </div>
